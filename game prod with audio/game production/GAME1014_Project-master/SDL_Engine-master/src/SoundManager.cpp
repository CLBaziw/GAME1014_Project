...
SoundManager::SoundManager()
{
	...
	panReset();
	load("../Assets/audio/startScreen.mp3", "startScreen", SOUND_MUSIC);
	load("../Assets/audio/level1.mp3", "level1", SOUND_MUSIC);
	load("../Assets/audio/level2.mp3", "level2", SOUND_MUSIC);
	load("../Assets/audio/level3.mp3", "level3", SOUND_MUSIC);
