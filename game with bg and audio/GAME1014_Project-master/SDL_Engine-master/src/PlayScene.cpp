...
void PlayScene::start()
{
	...
	if (TheGame::Instance()->getLevel() == 0)
	{
		...
		std::cout << "Lashaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa1" << std::endl;
		SoundManager::Instance().playMusic("1st");
	}
	else if(TheGame::Instance()->getLevel() == 1)
	{
		...
		std::cout << "Lashaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa2" << std::endl;
		SoundManager::Instance().playMusic("2nd");
	}
	else
	{
		m_pBackground = new Background("../Assets/backgrounds/playscene3.jpg", "playscene-background", BACKGROUND, glm::vec2(0, y), false);
		std::cout << "Lashaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa3" << std::endl;
		SoundManager::Instance().playMusic("3rd");
	}
